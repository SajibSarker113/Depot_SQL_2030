...
FROM SCENT.SAMP_MAS A, SCENT.SAMP_DET B,SCENT.FP_MGR C, SCENT.INV_PROD D
	...
	and a.fl_mvh=C.FL_MVH
	AND C.FL_MVH=D.DIV_CD
	AND A.BILL_v_DT BETWEEN '01FEB2023' AND '28FEB2023'
	AND A.BILL_V_NO=B.BILL_V_NO  
	AND A.FP_ID=C.FP_ID
	AND B.TYP_CD=D.TYP_CD
	AND B.CAT_CD||B.PRD_CD=D.CAT_CD||D.PRD_CD
...
FROM SCENT.SAMP_MAS A, SCENT.SAMP_DET B,SCENT.FP_MGR C, SCENT.INV_PROD D
	...
	and a.fl_mvh=C.FL_MVH
	AND C.FL_MVH=D.DIV_CD
	AND A.BILL_v_DT BETWEEN '01MAR2023' AND '31MAR2023'
	AND A.BILL_V_NO=B.BILL_V_NO  
	AND A.FP_ID=C.FP_ID
	AND B.TYP_CD=D.TYP_CD
	AND B.CAT_CD||B.PRD_CD=D.CAT_CD||D.PRD_CD
...
FROM SCENT.SAMP_MAS A, SCENT.SAMP_DET B,SCENT.FP_MGR C, SCENT.INV_PROD D
	...
	and a.fl_mvh=C.FL_MVH
	AND C.FL_MVH=D.DIV_CD
	AND A.BILL_v_DT BETWEEN '01APR2023' AND '30APR2023'
	AND A.BILL_V_NO=B.BILL_V_NO  
	AND A.FP_ID=C.FP_ID
	AND B.TYP_CD=D.TYP_CD
	AND B.CAT_CD||B.PRD_CD=D.CAT_CD||D.PRD_CD
...
FROM SCENT.SAMP_MAS A, SCENT.SAMP_DET B,SCENT.FP_MGR C, SCENT.INV_PROD D
	...
	and a.fl_mvh=C.FL_MVH
	AND C.FL_MVH=D.DIV_CD
	AND A.BILL_v_DT BETWEEN '01MAY2023' AND '31MAY2023'
	AND A.BILL_V_NO=B.BILL_V_NO  
	AND A.FP_ID=C.FP_ID
	AND B.TYP_CD=D.TYP_CD
	AND B.CAT_CD||B.PRD_CD=D.CAT_CD||D.PRD_CD
...
FROM SCENT.SAMP_MAS A, SCENT.SAMP_DET B,SCENT.FP_MGR C, SCENT.INV_PROD D
	...
	and a.fl_mvh=C.FL_MVH
	AND C.FL_MVH=D.DIV_CD
	AND A.BILL_v_DT BETWEEN '01JUN2023' AND '30JUN2023'
	AND A.BILL_V_NO=B.BILL_V_NO  
	AND A.FP_ID=C.FP_ID
	AND B.TYP_CD=D.TYP_CD
	AND B.CAT_CD||B.PRD_CD=D.CAT_CD||D.PRD_CD
...
FROM SCENT.SAMP_MAS A, SCENT.SAMP_DET B,SCENT.FP_MGR C, SCENT.INV_PROD D
	...
	and a.fl_mvh=C.FL_MVH
	AND C.FL_MVH=D.DIV_CD
	AND A.BILL_v_DT BETWEEN '01JUL2023' AND '31JUL2023'
	AND A.BILL_V_NO=B.BILL_V_NO  
	AND A.FP_ID=C.FP_ID
	AND B.TYP_CD=D.TYP_CD
	AND B.CAT_CD||B.PRD_CD=D.CAT_CD||D.PRD_CD
...
FROM SCENT.SAMP_MAS A, SCENT.SAMP_DET B,SCENT.FP_MGR C, SCENT.INV_PROD D
	...
	and a.fl_mvh=C.FL_MVH
	AND C.FL_MVH=D.DIV_CD
	AND A.BILL_v_DT BETWEEN '01AUG2023' AND '31AUG2023'
	AND A.BILL_V_NO=B.BILL_V_NO  
	AND A.FP_ID=C.FP_ID
	AND B.TYP_CD=D.TYP_CD
	AND B.CAT_CD||B.PRD_CD=D.CAT_CD||D.PRD_CD
...
FROM SCENT.SAMP_MAS A, SCENT.SAMP_DET B,SCENT.FP_MGR C, SCENT.INV_PROD D
	...
	and a.fl_mvh=C.FL_MVH
	AND C.FL_MVH=D.DIV_CD
	AND A.BILL_v_DT BETWEEN '01SEP2023' AND '30SEP2023'
	AND A.BILL_V_NO=B.BILL_V_NO  
	AND A.FP_ID=C.FP_ID
	AND B.TYP_CD=D.TYP_CD
	AND B.CAT_CD||B.PRD_CD=D.CAT_CD||D.PRD_CD
...
FROM SCENT.SAMP_MAS A, SCENT.SAMP_DET B,SCENT.FP_MGR C, SCENT.INV_PROD D
	...
	and a.fl_mvh=C.FL_MVH
	AND C.FL_MVH=D.DIV_CD
	AND A.BILL_v_DT BETWEEN '01OCT2023' AND '31OCT2023'
	AND A.BILL_V_NO=B.BILL_V_NO  
	AND A.FP_ID=C.FP_ID
	AND B.TYP_CD=D.TYP_CD
	AND B.CAT_CD||B.PRD_CD=D.CAT_CD||D.PRD_CD
...
FROM SCENT.SAMP_MAS A, SCENT.SAMP_DET B,SCENT.FP_MGR C, SCENT.INV_PROD D
	...
	and a.fl_mvh=C.FL_MVH
	AND C.FL_MVH=D.DIV_CD
	AND A.BILL_v_DT BETWEEN '01NOV2023' AND '30NOV2023'
	AND A.BILL_V_NO=B.BILL_V_NO  
	AND A.FP_ID=C.FP_ID
	AND B.TYP_CD=D.TYP_CD
	AND B.CAT_CD||B.PRD_CD=D.CAT_CD||D.PRD_CD
...
FROM SCENT.SAMP_MAS A, SCENT.SAMP_DET B,SCENT.FP_MGR C, SCENT.INV_PROD D
	...
	and a.fl_mvh=C.FL_MVH
	AND C.FL_MVH=D.DIV_CD
	AND A.BILL_v_DT BETWEEN '01DEC2023' AND '31DEC2023'
	AND A.BILL_V_NO=B.BILL_V_NO  
	AND A.FP_ID=C.FP_ID
	AND B.TYP_CD=D.TYP_CD
	AND B.CAT_CD||B.PRD_CD=D.CAT_CD||D.PRD_CD
...
FROM S1
GROUP BY RM_ID,JAN,FEB,MAR,APR,MAY,JUN,JUL,AUG,SEP,OCT,NOV,DEC
ORDER BY RM_ID
/
